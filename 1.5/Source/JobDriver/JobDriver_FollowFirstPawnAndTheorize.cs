...
namespace HealersOfTheLighthouse
{
    public class JobDriver_FollowFirstPawnAndTheorize : JobDriver
    {
        ...
        TheorizeAbilitySettings TheorizeSettings => FirstPawn.abilities.GetAbility(MoyoMedicalExpansion_AbilityDefOfs.HOTL_RMBD_AbilityTheorize).def.GetModExtension<ModExtension>().theorizeAbilitySettings;
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            pathToChair.FailOn(() => FirstPawn.CurJobDef != MoyoMedicalExpansion_JobDefOfs.HOTL_TakeSecondPawnToTheorize);
            ...
            chatWithOther.FailOn(() => FirstPawn.CurJobDef != MoyoMedicalExpansion_JobDefOfs.HOTL_TakeSecondPawnToTheorize);
